...
function spoonerize(words) {
    // take input of a string of two words separated by a space
    // return the two words in a string with the first chars swapped
    // spoonerize('nit picking') => "pit nicking"
    
    // convert words to an array
    // return slice first char of each word + slice rest of word in template literal
